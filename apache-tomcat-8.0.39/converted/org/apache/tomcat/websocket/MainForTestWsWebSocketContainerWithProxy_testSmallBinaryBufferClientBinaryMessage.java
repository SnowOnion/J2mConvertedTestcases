...
public class MainForTestWsWebSocketContainerWithProxy_testSmallBinaryBufferClientBinaryMessage {
    public static void main(String[] args) {
        try {
            ...
            objTestWsWebSocketContainerWithProxy.testSmallBinaryBufferClientBinaryMessage();
