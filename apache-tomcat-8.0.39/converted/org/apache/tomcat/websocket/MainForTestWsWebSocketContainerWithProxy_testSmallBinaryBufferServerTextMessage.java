...
public class MainForTestWsWebSocketContainerWithProxy_testSmallBinaryBufferServerTextMessage {
    public static void main(String[] args) {
        try {
            ...
            objTestWsWebSocketContainerWithProxy.testSmallBinaryBufferServerTextMessage();
