...
public class MainForTestWsWebSocketContainerWithProxy_testConnectToServerEndpointSSL {
    public static void main(String[] args) {
        try {
            ...
            objTestWsWebSocketContainerWithProxy.testConnectToServerEndpointSSL();
