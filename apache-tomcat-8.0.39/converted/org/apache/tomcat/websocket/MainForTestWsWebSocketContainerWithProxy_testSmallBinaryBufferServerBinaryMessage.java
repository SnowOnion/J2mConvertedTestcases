...
public class MainForTestWsWebSocketContainerWithProxy_testSmallBinaryBufferServerBinaryMessage {
    public static void main(String[] args) {
        try {
            ...
            objTestWsWebSocketContainerWithProxy.testSmallBinaryBufferServerBinaryMessage();
