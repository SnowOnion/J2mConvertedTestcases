...
public class MainForTestWsWebSocketContainerWithProxy_testSmallTextBufferClientTextMessage {
    public static void main(String[] args) {
        try {
            ...
            objTestWsWebSocketContainerWithProxy.testSmallTextBufferClientTextMessage();
