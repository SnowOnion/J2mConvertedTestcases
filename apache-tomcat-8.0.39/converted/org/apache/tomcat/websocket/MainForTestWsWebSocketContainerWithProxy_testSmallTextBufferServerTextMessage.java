...
public class MainForTestWsWebSocketContainerWithProxy_testSmallTextBufferServerTextMessage {
    public static void main(String[] args) {
        try {
            ...
            objTestWsWebSocketContainerWithProxy.testSmallTextBufferServerTextMessage();
