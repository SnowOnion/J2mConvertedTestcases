...
public class MainForTestWsWebSocketContainerWithProxy_testConnectToServerEndpointNoHost {
    public static void main(String[] args) {
        try {
            ...
            objTestWsWebSocketContainerWithProxy.testConnectToServerEndpointNoHost();
