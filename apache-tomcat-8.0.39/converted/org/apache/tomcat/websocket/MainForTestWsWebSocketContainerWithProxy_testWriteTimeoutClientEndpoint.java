...
public class MainForTestWsWebSocketContainerWithProxy_testWriteTimeoutClientEndpoint {
    public static void main(String[] args) {
        try {
            ...
            objTestWsWebSocketContainerWithProxy.testWriteTimeoutClientEndpoint();
