...
public class MainForTestRestCsrfPreventionFilter_testPostRequestValidNonceAsParameterValidPath2 {
    public static void main(String[] args) {
        try {
            ...
            objTestRestCsrfPreventionFilter.testPostRequestValidNonceAsParameterValidPath2();
        } catch (Throwable e) {
            e.printStackTrace();
        }
    }
