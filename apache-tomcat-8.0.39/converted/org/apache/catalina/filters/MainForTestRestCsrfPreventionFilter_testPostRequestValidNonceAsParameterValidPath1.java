...
public class MainForTestRestCsrfPreventionFilter_testPostRequestValidNonceAsParameterValidPath1 {
    public static void main(String[] args) {
        try {
            ...
            objTestRestCsrfPreventionFilter.testPostRequestValidNonceAsParameterValidPath1();
        } catch (Throwable e) {
            e.printStackTrace();
        }
    }
