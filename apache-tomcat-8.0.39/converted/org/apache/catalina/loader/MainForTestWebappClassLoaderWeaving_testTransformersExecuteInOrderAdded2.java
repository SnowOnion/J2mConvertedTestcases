...
public class MainForTestWebappClassLoaderWeaving_testTransformersExecuteInOrderAdded2 {
    public static void main(String[] args) {
        try {
            ...
            objTestWebappClassLoaderWeaving.testTransformersExecuteInOrderAdded2();
