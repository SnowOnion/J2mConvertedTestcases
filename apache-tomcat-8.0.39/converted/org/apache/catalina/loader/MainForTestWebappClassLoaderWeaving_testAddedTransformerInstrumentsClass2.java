...
public class MainForTestWebappClassLoaderWeaving_testAddedTransformerInstrumentsClass2 {
    public static void main(String[] args) {
        try {
            ...
            objTestWebappClassLoaderWeaving.testAddedTransformerInstrumentsClass2();
