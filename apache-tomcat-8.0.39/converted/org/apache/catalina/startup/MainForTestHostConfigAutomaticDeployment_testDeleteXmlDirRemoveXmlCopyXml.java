...
public class MainForTestHostConfigAutomaticDeployment_testDeleteXmlDirRemoveXmlCopyXml {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testDeleteXmlDirRemoveXmlCopyXml();
