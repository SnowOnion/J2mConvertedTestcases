...
public class MainForTestHostConfigAutomaticDeployment_testDeploymentXmlExternalWarXmlFTF {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testDeploymentXmlExternalWarXmlFTF();
