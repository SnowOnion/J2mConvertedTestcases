...
public class MainForTestHostConfigAutomaticDeployment_testUpdateWarOfflineNoContextFT {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testUpdateWarOfflineNoContextFT();
