...
public class MainForTestHostConfigAutomaticDeployment_testDeploymentXmlExternalWarXmlTFT {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testDeploymentXmlExternalWarXmlTFT();
