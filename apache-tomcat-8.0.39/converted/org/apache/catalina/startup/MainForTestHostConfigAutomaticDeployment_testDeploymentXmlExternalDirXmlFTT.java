...
public class MainForTestHostConfigAutomaticDeployment_testDeploymentXmlExternalDirXmlFTT {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testDeploymentXmlExternalDirXmlFTT();
