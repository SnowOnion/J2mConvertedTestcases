...
public class MainForTestHostConfigAutomaticDeployment_testDeleteXmlExtwarDirRemoveDir {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testDeleteXmlExtwarDirRemoveDir();
