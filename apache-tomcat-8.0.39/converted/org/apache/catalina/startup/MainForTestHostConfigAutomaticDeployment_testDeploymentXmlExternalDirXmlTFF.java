...
public class MainForTestHostConfigAutomaticDeployment_testDeploymentXmlExternalDirXmlTFF {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testDeploymentXmlExternalDirXmlTFF();
