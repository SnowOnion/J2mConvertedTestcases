...
public class MainForTestHostConfigAutomaticDeployment_testUpdateWarOfflineNoContextTT {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testUpdateWarOfflineNoContextTT();
