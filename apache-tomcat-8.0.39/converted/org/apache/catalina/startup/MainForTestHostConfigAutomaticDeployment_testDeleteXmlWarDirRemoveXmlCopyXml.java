...
public class MainForTestHostConfigAutomaticDeployment_testDeleteXmlWarDirRemoveXmlCopyXml {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testDeleteXmlWarDirRemoveXmlCopyXml();
