...
public class MainForTestHostConfigAutomaticDeployment_testUpdateWarOfflineNoContextFF {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testUpdateWarOfflineNoContextFF();
