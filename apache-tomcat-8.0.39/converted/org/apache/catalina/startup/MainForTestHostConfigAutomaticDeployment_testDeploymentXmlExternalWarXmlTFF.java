...
public class MainForTestHostConfigAutomaticDeployment_testDeploymentXmlExternalWarXmlTFF {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testDeploymentXmlExternalWarXmlTFF();
