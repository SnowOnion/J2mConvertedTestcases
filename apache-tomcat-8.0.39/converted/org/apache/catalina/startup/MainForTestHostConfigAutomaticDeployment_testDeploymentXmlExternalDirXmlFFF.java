...
public class MainForTestHostConfigAutomaticDeployment_testDeploymentXmlExternalDirXmlFFF {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testDeploymentXmlExternalDirXmlFFF();
