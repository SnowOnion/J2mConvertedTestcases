...
public class MainForTestHostConfigAutomaticDeployment_testDeploymentXmlExternalDirXmlTTT {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testDeploymentXmlExternalDirXmlTTT();
