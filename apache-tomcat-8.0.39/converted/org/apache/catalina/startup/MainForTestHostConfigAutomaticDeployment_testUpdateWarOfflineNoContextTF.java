...
public class MainForTestHostConfigAutomaticDeployment_testUpdateWarOfflineNoContextTF {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testUpdateWarOfflineNoContextTF();
