...
public class MainForTestHostConfigAutomaticDeployment_testModifyXmlExtwarDirUpdateXml {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testModifyXmlExtwarDirUpdateXml();
