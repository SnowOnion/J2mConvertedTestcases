...
public class MainForTestHostConfigAutomaticDeployment_testDeploymentXmlExternalWarXmlFFF {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testDeploymentXmlExternalWarXmlFFF();
