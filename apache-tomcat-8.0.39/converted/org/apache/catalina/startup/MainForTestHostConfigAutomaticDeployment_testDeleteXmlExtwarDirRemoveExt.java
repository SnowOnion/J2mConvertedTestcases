...
public class MainForTestHostConfigAutomaticDeployment_testDeleteXmlExtwarDirRemoveExt {
    public static void main(String[] args) {
        try {
            ...
            objTestHostConfigAutomaticDeployment.testDeleteXmlExtwarDirRemoveExt();
